...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <form action="<?= base_url('master/updateDepartment'); ?>" method="POST" class="col-lg-5 col-md-6 col-sm-12 p-0">
            <div class="card rounded-0">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control-plaintext form-control-lg" name="d_id" value="<?= esc($d_old['id']); ?>">
                    </div>

                    <div class="form-group">
                        <label for="d_name" class="col-form-label-lg">Department Name</label>
                        <input type="text" class="form-control form-control-lg" name="d_name" id="d_name" value="<?= esc($d_old['name']); ?>">
