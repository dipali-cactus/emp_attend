      ...
      <div class="card rounded-0">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" readonly class="form-control-plaintext form-control-lg" name="l_id" value="<?= esc($l_old['id']); ?>">
          </div>

          <div class="form-group">
            <label for="l_name" class="col-form-label-lg">Location Name</label>
            <input type="text" class="form-control form-control-lg" name="l_name" id="l_name" value="<?= esc($l_old['name']); ?>">
            <?php if (session()->getFlashdata('errors') && isset(session()->getFlashdata('errors')['l_name'])): ?>
              <small class="text-danger"><?= session()->getFlashdata('errors')['l_name']; ?></small>
            <?php endif; ?>
          </div>
