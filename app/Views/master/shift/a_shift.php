...
<div class="container-fluid mb-3">
  ...
  <div class="row justify-content-center">
    <form action="<?= current_url(); ?>" method="POST" class="col-lg-5 col-md-6 col-sm-12 col-xs-12 p-0">
      <div class="card rounded-0">
        <h5 class="card-header">Shift Master Data</h5>
        <div class="card-body">
          <?= session()->getFlashdata('message'); ?>
          <h5 class="card-title">Add New Shift</h5>
          <p class="card-text">Form to add a new shift to the system</p>
          ...
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-4">
                <input type="number" class="form-control form-control-lg" name="s_start_h" id="s_start_h" max="23" min="0" placeholder="Hour" value="<?= esc(old('s_start_h')); ?>">
                <?= isset($validation) ? '<small class="text-danger">' . $validation->getError('s_start_h') . '</small>' : '' ?>
              </div>
              <div class="col-sm-4">
                <input type="number" class="form-control form-control-lg" name="s_start_m" id="s_start_m" max="59" min="0" placeholder="Minutes" value="<?= esc(old('s_start_m')); ?>">
                <?= isset($validation) ? '<small class="text-danger">' . $validation->getError('s_start_m') . '</small>' : '' ?>
              </div>
              <div class="col-sm-4">
                <input type="number" class="form-control form-control-lg" name="s_start_s" id="s_start_s" max="59" min="0" placeholder="Seconds" value="<?= esc(old('s_start_s')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-4">
                <input type="number" class="form-control form-control-lg" name="s_end_h" id="s_end_h" max="23" min="0" placeholder="Hour" value="<?= esc(old('s_end_h')); ?>">
                <?= isset($validation) ? '<small class="text-danger">' . $validation->getError('s_end_h') . '</small>' : '' ?>
              </div>
              <div class="col-sm-4">
                <input type="number" class="form-control form-control-lg" name="s_end_m" id="s_end_m" max="59" min="0" placeholder="Minutes" value="<?= esc(old('s_end_m')); ?>">
                <?= isset($validation) ? '<small class="text-danger">' . $validation->getError('s_end_m') . '</small>' : '' ?>
              </div>
              <div class="col-sm-4">
                <input type="number" class="form-control form-control-lg" name="s_end_s" id="s_end_s" max="59" min="0" placeholder="Seconds" value="<?= esc(old('s_end_s')); ?>">
